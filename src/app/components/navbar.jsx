    ...
    return (
        <nav className="container mx-auto p-4 flex justify-between items-center">
            ...
            <ul className={`flex space-x-4 p-2 rounded-full border ${theme === 'light' ? 'bg-gray-100 border-gray-300' : 'bg-zinc-800 border-white-500-30 shadow-zinc'}`}>
                ...
                <li>
                    <a href="/projects" className={`px-4 py-2 rounded-full ${theme === 'light' ? 'hover:text-gray-900 hover:bg-gray-200' : 'hover:text-white hover:bg-gray-600'}`}>Projects</a>
                </li>
                <li>
                    <a href="/uses" className={`px-4 py-2 rounded-full ${theme === 'light' ? 'hover:text-gray-900 hover:bg-gray-200' : 'hover:text-white hover:bg-gray-600'}`}>Uses</a>
                </li>
            </ul>
            <button
                onClick={toggleTheme}
