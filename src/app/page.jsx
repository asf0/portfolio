  ...
  return (
    <main className={`container mx-auto p-4 flex flex-col lg:flex-row lg:space-x-4`}>
      <section className={`max-w-8xl w-full shadow-sm rounded-sm p-12 md:flex md:flex-row`}>
        <div className="md:w-4/4 md:pr-8">
          ...
          <div className="md:w-3/4 mt-6">
            <article className="mb-4">
              <h2 className="text-xl font-bold">Article 1</h2>
              <p>
            ...
            <article className="mb-4">
              <h2 className="text-xl font-bold">Article 2</h2>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, incidunt numquam possimus fuga, optio modi officiis obcaecati doloremque neque beatae autem ea facilis. Nam fugit voluptas animi aut perspiciatis quo.
              </p>
            </article>
            <article className="mb-4">
              <h2 className="text-xl font-bold">Article 3</h2>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, incidunt numquam possimus fuga, optio modi officiis obcaecati doloremque neque beatae autem ea facilis. Nam fugit voluptas animi aut perspiciatis quo.
              </p>
            </article>
          ...
          <section className={`shadow-md p-4 rounded-sm mb-4 mt-10`}>
            ...
            <form className="flex space-x-2">
              ...
              <input
                ...
                id="email"
                name="email"
                className="shadow-sm block w-full sm:text-sm rounded-md bg-gray-200 text-gray-100 text-center"
          ...
          <section className={`shadow-md p-4 rounded-sm mb-4 mt-10`}>
            ...
            <ul>
              <li className="flex items-center justify-between">
                ...
                <span className={`text-sm ${theme === "light" ? "text-gray-500" : "text-gray-400"}`}>2020 - 2021</span>
              </li>
              <li className="flex items-center justify-between">
